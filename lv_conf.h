...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (8 * 1024 * 1024)          /*[bytes]*/

    /*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    #define LV_MEM_ADR 0     /*0: unused*/
    /*Instead of an address give a memory allocator that will be called to get a memory pool for LVGL. E.g. my_malloc*/
    #if LV_MEM_ADR == 0
        #define LV_MEM_POOL_INCLUDE "sstar_memory.h"/* Uncomment if using an external allocator*/
        #define LV_MEM_POOL_ALLOC   sstar_pool_malloc        /* Uncomment if using an external allocator*/
    #endif
